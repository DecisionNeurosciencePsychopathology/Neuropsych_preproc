function b=revmakeregressor(id,filenum)
...
% words in the Bandit e-prime files:
%	- NumRight					none
%	- Running					yes
%	- showstim.RESP				yes
%	- showstim.CRESP			yes
%	- showstim.ACC				yes
%	- showstim.OnsetTime		yes
%	- showstim.RT				yes
%	- Valid						none
% 	- Trialtype					none
...
for ct=1:length(b.Running)-1
  runningstr=char(b.Running(ct)); 
  nextrunningstr=char(b.Running(ct+1));
  % this string is not in the Bandit output
